Pod::Spec.new do |spec|
  ...
  spec.name         = "CustomRoundedBasitFramework"
  spec.version      = "0.0.1"
  ...
  spec.homepage     = "https://github.com/BasitTA/CustomRounded.git"
  ...
  spec.author             = { "basit" => "bta.aang@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/BasitTA/CustomRounded.git", :tag => "#{spec.version}" }

	# Replace value of source file with your Path
  spec.source_files  = "RoundedFramework/**/*.{swift}"
